...
\input{src/theory/style/design_tokens.tex}
\input{src/theory/style/math_support.tex}
\input{src/theory/figures/chapter_01_visuals.tex}
\input{src/theory/figures/chapter_02_05_visuals.tex}
\input{src/theory/figures/chapter_06_visuals.tex}
...
\hypersetup{
  ...
  pdfsubject={Libro de teoría para un primer curso de cálculo diferencial},
  ...
  pdfdoi={10.5281/zenodo.22306586},
  pdfmetalang={es},
  pdflang={es-ES},
